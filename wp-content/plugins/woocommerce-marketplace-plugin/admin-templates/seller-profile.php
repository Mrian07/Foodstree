...
if ( !is_wp_error( $errors ) ) {
	$redirect = '?page=seller-profile&action=update&updated=1';
...
<form id="your-profile" enctype="multipart/form-data" action="<?php echo '?page=seller-profile&action=update&updated=1&seller=' . $user_id; ?>" method="post" novalidate="novalidate"<?php do_action( 'user_edit_form_tag' ); ?>>
